...
\begin{abstract}
	Diese Machbarkeitsstudie wurde im Rahmen einer Bachelorarbeit der hochschule Luzern für die Kooperative Speicherbibliothek Schweiz entwickelt. Dabei wurden für die Lösung eines Problems zwei unterschiedliche Konbzepte entwickelt, von welchen das technisch Realisierbare für diese Machbarkeitsstudie selektiert wurde. Dieses Konzept löst das Problem, dass ein Exemplar, welche in Behältern im Hochregallager eingelagert werden, in einen falschen Behälter deplatziert wird.
