...
Das Hochregallager hat die Dimensionen 70m x 20m x 15m, und um die besten Lagerbedingungen für die Bücher herzustellen, eine Temperatur von 18\SIDegreeCelsius ($\pm$ 2) und eine relative Luftfeuchtigkeit von 45\% ($\pm$5\%). Als Brandschutzmassnahme wird der Sauerstoffgehalt im Lager von den normalen 21\% Luftsauerstoff durch Injektion von Stickstoff auf 13.5\% gesenkt. Dies unterdrückt die Ausbreitung von Bränden.
...
Da RFID im Funkspektrum agiert, bestehen regulatorische Vorschriften bezüglich der Sendestärke. So darf in der Schweiz auf dem 13.56MHz Frequenband für Nahbereichsanwendung die Sendestärke auf zehn Metern maximal 60 dB$\mu$A betragen.
...
Es existieren keine relevanten finanziellen Anreize für unser Projekt von Seiten der Regierung.
